...
docker-build: ## docker build -t ${REPO}/${PROJECT}:${TAG}, try make build-image REPO=<YourRepoHost>, default ${PROJECT}=loggie, ${TAG} generated by git
	docker build -t ${REPO}/${PROJECT}:${TAG} .

docker-push: ## docker push ${REPO}/${PROJECT}:${TAG}
