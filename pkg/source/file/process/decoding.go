...
func (en *EncodingProcess) Order() int {
	return 400
}

func (en *EncodingProcess) Code() string {
	return "decoding"
}

func (en *EncodingProcess) Process(processorChain file.ProcessChain, ctx *file.JobCollectContext) {
	defer func() {
	...
	codec, ok := AllEncodings[en.charset]
